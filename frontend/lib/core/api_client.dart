...
extension AuthApi on Dio {
  ...
  Future<Map<String, dynamic>> loginStep1({required String username}) async {
    final res = await post('/auth/login/step1', data: {'username': username});
    return res.data as Map<String, dynamic>;
  }

  Future<Map<String, dynamic>> loginStep2({
    required String username,
    required String authHash,
  }) async {
    final res = await post('/auth/login/step2', data: {
      'username': username,
      'auth_hash': authHash,
    });
    return res.data as Map<String, dynamic>;
